...
<link href="${pageContext.request.contextPath }/font/css/font-awesome.min.css"  rel="stylesheet" type="text/css" />
...
<body>
 ...
 <!--顶部-->
  <div class="Sellerber_header apex clearfix" id="Sellerber_header">
   <div class="l_f logo header"><font style="font-size: 40px">学生信息管理系统</font></font></div>
   ...
   <div class="news l_f "><a href="#" class="fa fa-bell Notice prompt" id="promptbtn"></a><em>5</em></div>
     <div class="administrator l_f">
       <img src="${pageContext.request.contextPath }/images/avatar.png"  width="36px"/><span class="user-info">欢迎你,${userSession.user_name}</span><i class="glyph-icon fa  fa-caret-down"></i>
...
<!--内容-->
  ...
  <div class="show_iframe index_home" id="show_iframe">
       <iframe scrolling="yes" class="simei_iframe" frameborder="0" src="${pageContext.request.contextPath }/student/toright_index" name="iframepage" ></iframe>
       </div>
      </div>
  </div>
<!--底部-->
  <div class="Sellerber_bottom info" id="bottom">
  <span class="l_f"  style="text-align: center;" >毕业设计2018</span>
  </div>
  <!--消息提示板块内容-->
