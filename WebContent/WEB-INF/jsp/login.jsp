								...
								<div id="login-box" class="login-box widget-box no-border visible">				
                                  ...
                                  <div class="login_icon"><img src="images/login_img.png" /></div>
                                    ...
                                    <h4 class="title_name"><img src="images/login_title.png" /></h4>
										<fieldset>
										<ul>
   <li class="frame_style form_error"><label class="user_icon"></label><input name="" type="text" data-name="用户名" id="user_name"/><i>用户名</i></li>
   <li class="frame_style form_error"><label class="password_icon"></label><input name="" type="password"   data-name="密码" id="user_password"/><i>密码</i></li>
